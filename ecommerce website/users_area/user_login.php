...
if (validatePassword($user_password)) {
    ...
    echo "Password should contain at least 8 characters, including uppercase, lowercase, number, and special character.";
}
?> -->

                    <div class="mt-4 pt-2">
                        <input type="submit" value="Login"class="bg-warning py-2 
                        px-3 border-0" name="user_login">
    ...
    $select_query="Select * from `user_table` where
     ...
     if($row_count>0){
        ...
        if(password_verify($user_password,$row_data['user_password'])){
            ...
            echo"<script>alert('Invailid Credentials')</script>";
        }
     }else{
        echo"<script>alert('Invailid Credentials')</script>";
     }
